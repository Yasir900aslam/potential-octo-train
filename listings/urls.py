...
from .views import get_all_lists, get_list_with_id, get_all_hotel_rooms_type, get_hotel_room_type, get_hotel_rooms, get_specific_hotel_room, get_all_reservations, get_specific_reservation
